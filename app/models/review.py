...
class Review(db.Model):
    ...
    author = db.relationship(
        'User', back_populates='reviews_created', foreign_keys=author_id)
    reviewed_user = db.relationship(
        'User', back_populates='reviews_recieved', foreign_keys=reviewed_user_id)
    ...
    def to_dict(self):
        return {
            ...
            'author': self.author.to_author_dict(),
